    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btn.setOnClickListener(V -> {
            ...
            if (TextUtils.isEmpty(username)) {
                Toast.makeText(AddUser.this, "Please write your username...", Toast.LENGTH_SHORT).show();
            } else if (TextUtils.isEmpty(Email)) {
                Toast.makeText(AddUser.this, "Please write your email...", Toast.LENGTH_SHORT).show();
            } else if (TextUtils.isEmpty(password)) {
                Toast.makeText(AddUser.this, "Please write your password...", Toast.LENGTH_SHORT).show();
            } else {
                ...
                dao.add(us).addOnSuccessListener(suc ->
                {
                    ...
                    Intent intent = new Intent(AddUser.this, MainActivityAdmin.class);
